...
.field private mTargetDrawableArray:[Landroid/graphics/drawable/Drawable;
...
.method private getDirectionDescription(I)Ljava/lang/String;
    ...
    .prologue
    .line 973
    iget-object v2, p0, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->mDirectionDescriptions:Ljava/util/ArrayList;
    ...
    .line 974
    :cond_c
    iget v2, p0, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->mDirectionDescriptionsResourceId:I

    invoke-direct {p0, v2}, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->loadDescriptions(I)Ljava/util/ArrayList;

    move-result-object v2

    iput-object v2, p0, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->mDirectionDescriptions:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->mDirectionDescriptions:Ljava/util/ArrayList;
    ...
    const-string v3, "The number of target drawables must be euqal to the number of direction descriptions."
...
.method private getTargetDescription(I)Ljava/lang/String;
    ...
    .prologue
    .line 956
    iget-object v2, p0, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->mTargetDescriptions:Ljava/util/ArrayList;
    ...
    .line 957
    :cond_c
    iget v2, p0, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->mTargetDescriptionsResourceId:I

    invoke-direct {p0, v2}, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->loadDescriptions(I)Ljava/util/ArrayList;

    move-result-object v2

    iput-object v2, p0, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->mTargetDescriptions:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->mTargetDescriptions:Ljava/util/ArrayList;
    ...
    const-string v3, "The number of target drawables must be euqal to the number of target descriptions."
...
.method private internalSetTargetResources([Landroid/graphics/drawable/Drawable;)V
    .registers 8
    .parameter "drawables"
    ...
    .line 536
    .local v3, targetDrawables:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/widget/multiwaveview/TargetDrawable;>;"
    const/4 v1, 0x0
    ...
    invoke-direct {v4, v2, v5}, Lcom/android/internal/widget/multiwaveview/TargetDrawable;-><init>(Landroid/content/res/Resources;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 539
    :cond_1e
    iput-object p1, p0, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->mTargetDrawableArray:[Landroid/graphics/drawable/Drawable;

    .line 540
    iput-object v3, p0, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->mTargetDrawables:Ljava/util/ArrayList;
...
.method public getTargetDrawableArray()[Landroid/graphics/drawable/Drawable;
    .registers 2

    .prologue
    .line 572
    iget-object v0, p0, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->mTargetDrawableArray:[Landroid/graphics/drawable/Drawable;
...
.method public setTargetResources([Landroid/graphics/drawable/Drawable;)V
    .registers 3
    .parameter "drawables"
    ...
    .line 563
    :cond_5
    invoke-direct {p0, p1}, Lcom/android/internal/widget/multiwaveview/MultiWaveView;->internalSetTargetResources([Landroid/graphics/drawable/Drawable;)V
