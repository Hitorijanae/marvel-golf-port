...
.method public enter()V
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$7600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;I)V
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$7700(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)V

    .line 1037
    iget-object v0, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$GroupCreatedState;->this$1:Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;

    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->sendP2pConnectionChangedBroadcast()V
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$7800(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)V
...
.method public processMessage(Landroid/os/Message;)Z
    ...
    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->logd(Ljava/lang/String;)V
    invoke-static {v13, v14}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$400(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)V
    ...
    sparse-switch v13, :sswitch_data_4fc
    ...
    .line 1049
    .local v10, interfaceAddress:Ljava/lang/String;
    ...
    const-string v14, "Enter  GroupCreatedState"

    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->loge(Ljava/lang/String;)V
    invoke-static {v13, v14}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)V
    ...
    invoke-static {v13, v10}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$7900(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v13, v6, v14}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$5200(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;I)V
    ...
    invoke-static {v13}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$4400(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)V

    .line 1208
    .end local v6           #deviceAddress:Ljava/lang/String;
    .end local v10           #interfaceAddress:Ljava/lang/String;
    :goto_8c
    const/4 v13, 0x1
    ...
    .line 1053
    .restart local v10       #interfaceAddress:Ljava/lang/String;
    :cond_8e
    move-object v6, v10
    ...
    const-string v15, "Connect on unknown device address : "
    ...
    invoke-static {v13}, Landroid/net/wifi/p2p/WifiP2pService;->access$4900(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    invoke-static {v13}, Landroid/net/wifi/WifiNative;->p2pGroupRemove(Ljava/lang/String;)Z
    ...
    const-string v15, "Disconnect on unknown device address : "
    ...
    check-cast v8, Landroid/net/DhcpInfoInternal;

    .line 1096
    .local v8, dhcpInfo:Landroid/net/DhcpInfoInternal;
    move-object/from16 v0, p1
    ...
    iget-object v14, v8, Landroid/net/DhcpInfoInternal;->serverAddress:Ljava/lang/String;

    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->setWifiP2pInfoOnGroupFormation(Ljava/lang/String;)V
    invoke-static {v13, v14}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$7700(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)V
    ...
    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->sendP2pConnectionChangedBroadcast()V
    invoke-static {v13}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$7800(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)V
    ...
    .line 1106
    .end local v8           #dhcpInfo:Landroid/net/DhcpInfoInternal;
    :sswitch_21b
    move-object/from16 v0, p0
    ...
    invoke-virtual {v13, v14}, Landroid/net/wifi/p2p/WifiP2pDevice;->setCreateGroupOwner(Z)V
    ...
    invoke-static {v13, v0, v14}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$1500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Message;I)V
    ...
    invoke-virtual {v13, v4}, Landroid/net/wifi/p2p/WifiP2pDevice;->equals(Ljava/lang/Object;)Z
    ...
    const-string v15, "Remove peer "

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v14

    iget-object v15, v4, Landroid/net/wifi/p2p/WifiP2pDevice;->deviceAddress:Ljava/lang/String;
    ...
    invoke-static {v13}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8000(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)V
    ...
    invoke-static {v13, v14}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8100(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)V
    ...
    invoke-static {v13, v14}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$1302(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pGroup;)Landroid/net/wifi/p2p/WifiP2pGroup;
    ...
    invoke-static {v14}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$3600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$InactiveState;

    move-result-object v14

    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->transitionTo(Lcom/android/internal/util/IState;)V
    invoke-static {v13, v14}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8200(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Lcom/android/internal/util/IState;)V
    ...
    const-string/jumbo v14, "stop DHCP client"
    ...
    invoke-static {v13}, Landroid/net/wifi/p2p/WifiP2pService;->access$5700(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/net/DhcpStateMachine;
    ...
    invoke-virtual {v13}, Landroid/net/DhcpStateMachine;->quit()V
    ...
    invoke-static {v13, v14}, Landroid/net/wifi/p2p/WifiP2pService;->access$5702(Landroid/net/wifi/p2p/WifiP2pService;Landroid/net/DhcpStateMachine;)Landroid/net/DhcpStateMachine;

    goto :goto_326

    .line 1148
    .end local v2           #changed:Z
    .end local v7           #devices:Ljava/util/Collection;,"Ljava/util/Collection<Landroid/net/wifi/p2p/WifiP2pDevice;>;"
    .end local v9           #i$:Ljava/util/Iterator;
    :sswitch_38d
    move-object/from16 v0, p1
    ...
    invoke-virtual {v5, v13}, Landroid/net/wifi/p2p/WifiP2pDevice;->equals(Ljava/lang/Object;)Z
    ...
    const-string v14, "Lost the group owner, killing p2p connection"
    ...
    invoke-virtual {v13, v5}, Landroid/net/wifi/p2p/WifiP2pGroup;->removeClient(Landroid/net/wifi/p2p/WifiP2pDevice;)Z
    ...
    const-string v14, "Client list empty, removing a non-persistent p2p group"
    ...
    invoke-static {v13, v0}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8300(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/os/Message;)V
    ...
    #setter for: Landroid/net/wifi/p2p/WifiP2pService;->mInvitedDeviceAddress:Ljava/lang/String;
    invoke-static {v13, v14}, Landroid/net/wifi/p2p/WifiP2pService;->access$8402(Landroid/net/wifi/p2p/WifiP2pService;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v13, v14}, Landroid/net/wifi/WifiNative;->p2pInvite(Landroid/net/wifi/p2p/WifiP2pGroup;Ljava/lang/String;)Z
    ...
    #calls: Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->updateDeviceStatus(Ljava/lang/String;I)V
    invoke-static {v13, v14, v15}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$5200(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;I)V
    ...
    #getter for: Landroid/net/wifi/p2p/WifiP2pService;->mInvitedDeviceAddress:Ljava/lang/String;
    invoke-static {v14}, Landroid/net/wifi/p2p/WifiP2pService;->access$8400(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/lang/String;
    ...
    invoke-static {v14, v13}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pDevice;)V
    ...
    invoke-static {v14, v13}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$8600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pDevice;)V
    ...
    invoke-static {v13}, Landroid/net/wifi/WifiNative;->wpsPin(Ljava/lang/String;)Z
