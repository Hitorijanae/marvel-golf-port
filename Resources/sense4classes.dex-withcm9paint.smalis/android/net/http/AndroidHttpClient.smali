...
.method public static newInstance(Ljava/lang/String;)Landroid/net/http/AndroidHttpClient;
    ...
    .line 156
    invoke-static {p0, v0, v0}, Landroid/net/http/AndroidHttpClient;->newInstance(Ljava/lang/String;Landroid/content/Context;Lorg/apache/http/conn/ClientConnectionManager;)Landroid/net/http/AndroidHttpClient;
...
.method public static newInstance(Ljava/lang/String;Landroid/content/Context;)Landroid/net/http/AndroidHttpClient;
    ...
    invoke-static {p0, p1, v0}, Landroid/net/http/AndroidHttpClient;->newInstance(Ljava/lang/String;Landroid/content/Context;Lorg/apache/http/conn/ClientConnectionManager;)Landroid/net/http/AndroidHttpClient;
...
.method public static newInstance(Ljava/lang/String;Landroid/content/Context;Lorg/apache/http/conn/ClientConnectionManager;)Landroid/net/http/AndroidHttpClient;
    .registers 12
    .parameter "userAgent"
    .parameter "context"
    .parameter "shutdownccm"
    ...
    .restart local v3       #sessionCache:Landroid/net/SSLSessionCache;
    :cond_5a
    move-object v0, p2
...
.method public static newInstance(Ljava/lang/String;Lorg/apache/http/conn/ClientConnectionManager;)Landroid/net/http/AndroidHttpClient;
    .registers 3
    .parameter "userAgent"
    .parameter "shutdownccm"
    ...
    invoke-static {p0, v0, p1}, Landroid/net/http/AndroidHttpClient;->newInstance(Ljava/lang/String;Landroid/content/Context;Lorg/apache/http/conn/ClientConnectionManager;)Landroid/net/http/AndroidHttpClient;
