.class public Landroid/os/memory/HtcMemoryMeasurer$MemoryInfo;
...
# instance fields
.field public cacheMem:J

.field public freeMem:J

.field public totalMem:J

.field public usedMem:J
...
.method public constructor <init>(Landroid/os/memory/HtcMemoryMeasurer$MemoryInfo;)V
    .registers 4
    .parameter "memInfo"
...
.method public toString()Ljava/lang/String;
    ...
    iget-wide v2, p0, Landroid/os/memory/HtcMemoryMeasurer$MemoryInfo;->totalMem:J
    ...
    const-string v2, "cacheMem="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-wide v2, p0, Landroid/os/memory/HtcMemoryMeasurer$MemoryInfo;->cacheMem:J
    ...
    iget-wide v2, p0, Landroid/os/memory/HtcMemoryMeasurer$MemoryInfo;->freeMem:J
    ...
    const-string/jumbo v2, "usedMem="

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-wide v2, p0, Landroid/os/memory/HtcMemoryMeasurer$MemoryInfo;->usedMem:J
    ...
    const-string/jumbo v2, "secondaryServerThreshold="
...
.method public toString(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string v2, "   secondaryServerThreshold: "
