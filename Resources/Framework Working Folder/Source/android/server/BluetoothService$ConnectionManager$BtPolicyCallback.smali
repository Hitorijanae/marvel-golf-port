...
.method constructor <init>(Landroid/server/BluetoothService$ConnectionManager;Landroid/bluetooth/IBluetoothCallback;I)V
    ...
    invoke-static {p1, p3}, Landroid/server/BluetoothService$ConnectionManager;->access$600(Landroid/server/BluetoothService$ConnectionManager;I)I
    ...
    invoke-static {p1}, Landroid/server/BluetoothService$ConnectionManager;->access$500(Landroid/server/BluetoothService$ConnectionManager;)Ljava/util/LinkedList;
    ...
    :try_end_4e
    .catch Ljava/util/NoSuchElementException; {:try_start_1a .. :try_end_4e} :catch_4f
    ...
    invoke-static {p1}, Landroid/server/BluetoothService$ConnectionManager;->access$700(Landroid/server/BluetoothService$ConnectionManager;)I
    ...
    .line 1313
    invoke-static {p1}, Landroid/server/BluetoothService$ConnectionManager;->access$704(Landroid/server/BluetoothService$ConnectionManager;)I
...
.method removeHandle(I)Z
    ...
    #getter for: Landroid/server/BluetoothService$ConnectionManager;->mBtPolicyHandlesAvailable:Ljava/util/LinkedList;
    invoke-static {v0}, Landroid/server/BluetoothService$ConnectionManager;->access$500(Landroid/server/BluetoothService$ConnectionManager;)Ljava/util/LinkedList;
